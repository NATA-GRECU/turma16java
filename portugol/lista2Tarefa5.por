programa
{
	...
	funcao inicio()
	{
		 ...
		 * Se o índice sobe para 0,3 as indústrias do 1º grupo são intimadas a suspenderem suas atividades, s
		 * e o índice crescer para 0,4 as industrias do 1º e 2º grupo são intimadas a suspenderem suas atividades, 
		 ...
		 */
		 ...
		 real indicePoluicao, grupo1, grupo2, grupo3
		 ...
		 {
		 	escreva("Sua industria está com um indice de poluição aceitavel!")
		 }
		 senao se (indicePoluicao>=0.3 e indicePoluicao<0.4)
		 {
		 	escreva("Todos as industrias do 1º Grupo devem ser intimadas a suspenderem suas atividades.") 
		 }
		 senao se (indicePoluicao>=0.4 e indicePoluicao<0.5)
		 {
		 	escreva("Todos as industrias do 1º e 2º Grupo devem ser intimadas a suspenderem suas atividades.") 
		 }
		 senao
		 {
